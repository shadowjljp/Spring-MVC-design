...
<%-- <jsp:useBean id="idSearch" class="model.bookDAO" scope="page" /> --%>
<%-- <jsp:setProperty property="getbookid" name="idSearch" value="<%=bookid%>" /> --%>
<%-- <% Map myResult = idSearch.trToMap(idSearch.getBook()); %> --%>
<html>

		<head>
			<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<%-- 			<meta name="keywords" content="<%=myResult.get("getBook_name_zh")%>"> --%>
<%-- 			<title>享讀-<%=myResult.get("getBknamezh")%></title> --%>
			<meta http-equiv="X-UA-Compatible" content="IE=edge">
			<link rel="icon" type="image/x-icon" href="<c:url value=" /component/images/ReadShare.ico "/>">
			<link rel="stylesheet" href="<c:url value=" /component/js/jquery-1.12.1-ui.js "/>">
			...
			<script src="<c:url value=" /component/js/jquery-1.12.1-ui.js "/>"></script>
			<script>
				$(function () {
					$("#tabs").tabs({
						event: "mouseover"
