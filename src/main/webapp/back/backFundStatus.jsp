                ...
                $(document).ready(function () {
                    ...
                    $.get("../backproj.controller", { "times": i}, function (projectBeans) {
                        projectBeans.forEach(function (bean) {
                        	if(bean[4]=="審核中"){
                                $('#newtr').append("<tr><td>" + bean[4] + "</td><td>" + bean[3] + "</td><td>" + bean[0] + "</td><td>" + bean[1] + "</td><td>" + bean[2] + "</td><td><form action='<c:url value='/selectproj.controller'/>' method='get'><input type='hidden' name='id' value="+bean[0]+"><button type='submit'>審核</button></form></td></tr>");
                        	}
                        });//forEach
